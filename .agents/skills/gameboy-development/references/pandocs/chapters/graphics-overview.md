...
in 8×8 squares, called *tiles* (or sometimes “patterns” or “characters”), often considered as
...
The *objects* layer is designed to fill this gap: *objects* are made of 1 or 2 stacked tiles (8×8 or 8×16 pixels)
