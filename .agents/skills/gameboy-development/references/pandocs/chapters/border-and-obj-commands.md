...
It turns out that 29 rows of the border tilemap sent through PCT\_TRN are at least partly visible in some situations.
...
To fully eliminate flicker, write a row of all-black tilemap entries after the bottom row of the border ($8700-$873F in VRAM in a PCT\_TRN), or at least a row of tiles whose top row of pixels is blank.
