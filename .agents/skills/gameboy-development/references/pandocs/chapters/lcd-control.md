...
This bit is overridden on DMG by [bit 0](#lcdc0--bg-and-window-enablepriority)
...
This bit works similarly to [LCDC bit 6](#lcdc6--window-tile-map-area):
...
and the [Window Display Bit](#lcdc5--window-enable)
