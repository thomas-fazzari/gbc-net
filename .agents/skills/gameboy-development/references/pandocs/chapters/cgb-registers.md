...
OPRI has an effect if a [PGB](#pgb-mode) value (`0xX8`, `0xXC`) is written to [KEY0](#ff4c--key0sys-cgb-mode-only-cpu-mode-select) but STOP hasn’t been executed yet, and the write takes effect instantly.
