...
All later Mani 4 in 1 cartridges use [the MMM01 mapper](mmm01.md#mmm01), so the M161 mapper could be considered the predecessor to the MMM01.
...
It may be best to have the bankswitch code placed right before $0100, so as to fall through to [the game’s init sequence](the-cartridge-header.md#0100-0103--entry-point).
