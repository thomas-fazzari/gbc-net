...
[Memory Bank Controllers](mbcs.md#mbcs).
...
[speed switch](cgb-registers.md#ff4d--key1spd-cgb-mode-only-prepare-speed-switch).
...
it is reset to the value specified in TMA (FF06) and [an interrupt](interrupt-sources.md#int-50--timer-interrupt)
is requested, as described below.

## FF06 — TMA: Timer modulo

When TIMA overflows, it is reset to the value in this register and [an interrupt](interrupt-sources.md#int-50--timer-interrupt) is requested.
...
Note that writing to this register [may increase `TIMA` once](timer-obscure-behaviour.md#relation-between-timer-and-divider-register)!
