...
namespace GbcNet.App.Infrastructure.Persistence.Migrations
{
    ...
    public partial class InitialLibrarySchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_known_path = table.Column<string>(
                        type: "TEXT",
                        maxLength: 4096,
                        nullable: false
                    ),
                    file_name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    cartridge_title = table.Column<string>(
                        type: "TEXT",
                        maxLength: 16,
                        nullable: true
                    ),
                    hardware_kind = table.Column<string>(
                        type: "TEXT",
                        maxLength: 3,
                        nullable: false
                    ),
                    ...
                    last_opened_at = table.Column<string>(
                        type: "TEXT",
                        maxLength: 33,
                        nullable: false
                    ),
                    launch_count = table.Column<int>(
                        type: "INTEGER",
                        nullable: false,
                        defaultValue: 0
                    ),
                    cover_path = table.Column<string>(
                        type: "TEXT",
                        maxLength: 4096,
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "roms");
        }
    }
}
